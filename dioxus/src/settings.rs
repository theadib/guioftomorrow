...
/// Curated list of well-known IANA timezones, mirroring the Flutter
/// contester's approach of offering a manageable subset rather than the
/// full IANA database.
