...
/// Curated list of well-known IANA timezones, mirroring the Flutter/Dioxus/
/// Iced/imgui contesters' approach of offering a manageable subset rather
/// than the full IANA database.
...
pub struct AppSettings {
    ...
    /// UI scale as a percentage (50..=200), multiplied into every font-size
    /// and spacing binding this app's own UI defines.
    pub ui_scale: i32,
    pub timezone: String,
}
